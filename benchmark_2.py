...
# benchmark 1 wartosc z następnego roku 


X_train = X.loc[:'2019-12-01', 'sell-out'].shift(12).dropna(axis=0).values.reshape(-1,1)
X_train.shape

y_train = y.loc['2019-01-01':'2019-12-01', 'sell-out'].values
y_train.shape

X_valid = X.shift(12).loc['2020-01-01':'2020-05-01', 'sell-out'].values.reshape(-1,1)
y_valid = y.loc['2020-01-01':'2020-05-01', 'sell-out'].values




X_test = X.shift(12).loc['2020-06-01':'2020-10-01', 'sell-out']
